...
class Metrics(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if _val_f1 > self.best_val_f1:
            self.model.save_weights('./muti_model/128_02_f1={}_model.hdf5'.format(_val_f1))
...
def main():
    ...
    K.clear_session()
    model,model_2,model_3 = build_model(pretrained_path,config,MAX_LEN,Cs_num=len(s2id)+1,cs_em_size=64,R_num=len(p2id))
